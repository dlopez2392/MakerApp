...
export const MODULE_THEMES: Record<ModuleId, ModuleTheme> = {
  home: {
    ...
    backgroundAsset: require("../../../assets/textures/home-workshop.png"),
  ...
  woodworking: {
    ...
    backgroundAsset: require("../../../assets/textures/woodworking-oak.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
  leather: {
    ...
    backgroundAsset: require("../../../assets/textures/leather-saddle.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
  resin: {
    ...
    backgroundAsset: require("../../../assets/textures/resin-pour.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
  soap: {
    ...
    backgroundAsset: require("../../../assets/textures/soap-lather.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
  cnc: {
    ...
    backgroundAsset: require("../../../assets/textures/cnc-aluminum.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
  knife: {
    ...
    backgroundAsset: require("../../../assets/textures/knife-forge.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
  candle: {
    ...
    backgroundAsset: require("../../../assets/textures/candle-wax.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
  laser: {
    ...
    backgroundAsset: require("../../../assets/textures/laser-grid.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
  printing: {
    ...
    backgroundAsset: require("../../../assets/textures/printing-ink.png"),
    darkOverlayOpacity: 0.1,
    lightOverlayOpacity: 0.06,
  },
};
